...
const files = {
    ...
    front_src   : 'public/assets/sass/gwpg-front.sass',
    front_dest  : './public/assets/css',
    front_watch : 'public/assets/sass/**/*.sass',
...
gulp.task('frontend_style', function() {
    ...
    .pipe( rename( {suffix: '.min'}) )
    .pipe( sourcemaps.write( './' ) )
    .pipe( gulp.dest(files.front_dest) )
});
...
gulp.task('default', ['style', 'frontend_style', 'js']);

gulp.task('watch', ['default'], function() {
    gulp.watch(files.style_watch, ['style']);
    gulp.watch(files.front_watch, ['frontend_style']);
